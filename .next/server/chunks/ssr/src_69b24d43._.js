...
"[project]/src/lib/data:f1fd0a [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$f1fd0a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:f1fd0a [app-ssr] (ecmascript) <text/javascript>");
...
function SidebarContentComponent({ setSimulationData, isSimulating, setIsSimulating, uploadedFiles, setUploadedFiles }) {
    ...
    const handleSubmit = (formData)=>{
        ...
        startTransition(()=>{
            (async ()=>{
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$f1fd0a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["runSimulationAction"])(null, formData);
                if (result.data) {
...
//# sourceMappingURL=src_69b24d43._.js.map