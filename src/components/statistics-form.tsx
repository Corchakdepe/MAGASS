// components/statistics-form.tsx
"use client";
...
export default function StatisticsForm({
  ...
  const [mapUserName, setMapUserName] = usePersistentState<string>(
    "stats_mapUserName",
    "",
  );
  ...
  return (
    <div className="space-y-4">
      <Tabs defaultValue="maps" className="w-full">
        <div className="rounded-lg border border-surface-3 bg-surface-1/85 backdrop-blur-md shadow-mac-panel p-2">
        ...
        <TabsContent value="filter" className="mt-3">
          <div className="rounded-lg border border-surface-3 bg-surface-1/85 backdrop-blur-md shadow-mac-panel p-3">
            <div className="mb-3">
        ...
        <TabsContent value="matrix" className="mt-3">
          <div className="rounded-lg border border-surface-3 bg-surface-1/85 backdrop-blur-md shadow-mac-panel p-3 space-y-3">
            <div>
