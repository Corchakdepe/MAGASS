    ...
    <div className="space-y-3">
      <div className="space-y-2">
        ...
        <Autocomplete
          ...
          onChange={(_, newValue) => setSelectedCharts(newValue.map((g) => g.key))}
            ...
            <div key={g.key} className="rounded-md border px-2 py-2">
              ...
              {(g.key === "graf_barras_est_med" || g.key === "graf_barras_est_acum") && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 items-start">
                  ...
                  <div className="space-y-1">
                    <Label className="text-[11px]">Días</Label>
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button variant="outline" className="h-7 w-full justify-between px-2 text-xs">
              ...
              {g.key === "graf_linea_comp_mats" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 items-start">
                  <div className="space-y-1">
                    <Label className="text-[11px]">Δ y modo</Label>
