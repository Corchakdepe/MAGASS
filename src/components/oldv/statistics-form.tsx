...
export default function StatisticsForm() {
    ...
    const handleAnalyze = async () => {
        ...
        // Campos comunes que tu backend espera en AnalysisArgs
        const commonPayload = {
            inputFolder: entrada || '',
            outputFolder: salida || '',
        ...
        // Ahora: un POST por cada mapa seleccionado, con JSON body
        const mapRequests = selectedMaps.map(async (apiKey) => {
            ...
            if (!res.ok) {
                throw new Error(`Error analizando mapa ${apiKey}: ${res.statusText}`);
            }
        ...
        try {
            ...
            // aquí puedes disparar un toast, refrescar lista de resultados, etc.
        } catch (e: any) {
