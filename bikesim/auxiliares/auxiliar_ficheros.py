...
from bikesim.dataStructure.data_matrix import Data_matrix


def formatoArchivo(nombreArchivo, extension):
    now = datetime.datetime.now()
    return now.strftime("%Y%m%d_%H%M%S") + "_" + nombreArchivo + "D"+str(Constantes.DELTA_TIME) + "S"+str(
        Constantes.PORCENTAJE_ESTRES) + "C"+str(Constantes.COSTE_ANDAR) + "." + extension
